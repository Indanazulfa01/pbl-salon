        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create Data Reservasi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="card card-info card-outline">
        <div class="card-header">
          <h3>Form Tambah Data Reservasi</h3>
        </div>

        <div class="card-body">
            <form action="{{url('store-reservasi')}}" method="post">
              @csrf
              <div class="form-group">
                <input type="text" id="nama_reservasi" name="nama_reservasi" class="form-control" placeholder="Nama Reservasi">
              </div>
              <div class="form-group">
